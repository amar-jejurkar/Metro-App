...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void Create_Metro_Map(Graph_M g)
		{
			...
			g.addVertex("Nashik Phata");
			g.addVertex("Phugewadi");
			g.addVertex("Sant Tukaram Nagar");
			g.addVertex("Vanaz");
			g.addVertex("Pune Airport");
			g.addVertex("Shivaji Nagar");
			g.addVertex("Hinjawadi");
			
			
			
			g.addEdge("Anand Nagar", "Garware College", 8);
			g.addEdge("Garware College", "Ideal Colony", 10);
			g.addEdge("Ideal Colony", "Nal Stop", 8);
			g.addEdge("Ideal Colony", "Kasarwadi", 6);
			g.addEdge("Kasarwadi", "Nashik Phata", 9);
			g.addEdge("Nashik Phata", "Phugewadi", 7);
			g.addEdge("Phugewadi", "Sant Tukaram Nagar", 6);
			g.addEdge("Vanaz", "Kasarwadi", 20);
			g.addEdge("Phugewadi", "Nashik Phata", 6);
			g.addEdge("Shivaji Nagar", "Pune Airport", 12);
			g.addEdge("Hinjawadi", "Shivaji Nagar", 10);
			g.addEdge("Hinjawadi", "Pune Airport", 15);
